...
public partial class Composition
{
	...
	private void Setup_6() => DI.Setup()
		.Bind<IDependency_0_0_1_2>().As(Lifetime.PerBlock).To(ctx => {
	...
	private void Setup_19() => DI.Setup()
		.Bind<IDependency_0_1_1_2>().As(Lifetime.PerBlock).To(ctx => {
	...
	private void Setup_24() => DI.Setup()
		.Bind<IDependency_0_1_2>().As(Lifetime.Transient).To(ctx => {
	...
	private void Setup_26() => DI.Setup()
		.Bind<IDependency_0_2_0_0>().As(Lifetime.Transient).To(ctx => {
	...
	private void Setup_66() => DI.Setup()
		.Bind<IDependency_1_2_0_1>().As(Lifetime.PerBlock).To(ctx => {
	...
	private void Setup_74() => DI.Setup()
		.Bind<IDependency_1_2_2_1>().As(Lifetime.PerResolve).To(ctx => {
	...
	private void Setup_81() => DI.Setup()
		.Bind<IDependency_2_0_0>().As(Lifetime.Transient).To(ctx => {
	...
	private void Setup_93() => DI.Setup()
		.Bind<IDependency_2_1_0_2>().As(Lifetime.PerResolve).To(ctx => {
	...
	private void Setup_98() => DI.Setup()
		.Bind<IDependency_2_1_1>().As(Lifetime.PerResolve).To(ctx => {
