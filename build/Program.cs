...
DI.Setup(nameof(Composition))
    ...
    .Bind<IInitializable, ITarget<string>>(typeof(GeneratorTarget)).To<GeneratorTarget>()
    .Bind<IInitializable, ITarget<IReadOnlyCollection<Library>>>(typeof(LibrariesTarget)).To<LibrariesTarget>()
    .Bind<IInitializable, ITarget<IReadOnlyCollection<string>>>(typeof(CompatibilityCheckTarget)).To<CompatibilityCheckTarget>()
    .Bind<IInitializable, ITarget<IReadOnlyCollection<string>>>(typeof(PackTarget)).To<PackTarget>()
