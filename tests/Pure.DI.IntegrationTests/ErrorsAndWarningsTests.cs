...
public class ErrorsAndWarningsTests
{
    ...
    [Fact]
    public async Task ShouldShowErrorWhenAllowsRefStructGenericOuterValueCapturedByGeneratedDelegate()
    {
        // Given
                           ...
                           namespace Sample
                           {
                                   ...
                                   where T : allows ref struct
                               {
                                   static void Setup() =>
                                       ...
                                       DI.Setup()
                                           .RootArg<T>("text")
                                           .Bind<ParserAction<T>>().To(ctx =>
                                           {
                                               ctx.Inject<T>(out var text);
                                               return new ParserAction<T>(() =>
                                               {
                                                   _ = text;
                                               });
                                           })
                                           .Root<ParserAction<T>>("Action");
                               }
    ...
    [Fact]
    public async Task ShouldSupportAllowsRefStructGenericDelegateArgumentWithImmediateOverride()
    {
        // Given
    ...
    [Fact]
    public async Task ShouldSupportAllowsRefStructGenericDelegateArgumentWithImmediateLet()
    {
        // Given
    ...
    [Fact]
    public async Task ShouldShowWarningWhenAllowsRefStructGenericDelegateArgumentLetIsNotLocked()
    {
        // Given
    ...
    [Fact]
    public async Task ShouldNotShowWarningWhenThreadSafeIsOffForAllowsRefStructGenericDelegateArgumentLet()
    {
        // Given
    ...
    [Fact]
    public async Task ShouldSupportManualLockForAllowsRefStructGenericDelegateArgumentLet()
    {
        // Given
    ...
    [Fact]
    public async Task ShouldSupportClosedReadOnlySpanGenericDelegateArgumentWithImmediateOverride()
    {
        // Given
                               ...
                               partial class Composition
                               {
                                   static void Setup() =>
                                       ...
                                       DI.Setup()
                                           ...
                                           .Root<ParserFactory<ReadOnlySpan<char>>>("Factory");
                               }
        ...
        result.Success.ShouldBeTrue(result);
        result.StdOut.ShouldBe(["True"], result);
        result.GeneratedCode.ShouldContain("ParserFactory<System.ReadOnlySpan<char>>");
        result.GeneratedCode.ShouldContain("Parser<System.ReadOnlySpan<char>>");
    }

    [Fact]
    public async Task ShouldShowErrorWhenAllowsRefStructGenericDelegateArgumentIsInjectedIntoProperty()
    {
        // Given
        ...
        result.Success.ShouldBeFalse(result);
        result.Errors.Count(i => i.Id == LogId.ErrorStackOnlyFieldOrPropertyInjection).ShouldBe(1, result);
        result.Errors.Count(i => i.Id == LogId.ErrorStackOnlyDelegateCapture).ShouldBe(0, result);
    }

    [Fact]
    public async Task ShouldShowErrorWhenAllowsRefStructGenericDelegateArgumentLetIsInjectedIntoProperty()
    {
        // Given
    ...
    [Fact]
    public async Task ShouldShowErrorWhenAllowsRefStructGenericDelegateArgumentIsCapturedByNestedDelegate()
    {
        // Given
        ...
        var result = await """
                           ...
                           namespace Sample
                           {
                               delegate Action ParserFactory<T>(T text)
                                   where T : allows ref struct;
                                   ...
                                   where T : allows ref struct
                               {
                                   static void Setup() =>
                                       // Resolve = Off
                                       DI.Setup()
                                           .Bind<ParserFactory<T>>().To(ctx => new ParserFactory<T>(text => new Action(() =>
                                           {
                                               ctx.Override<T>(text);
                                               ctx.Inject<Parser<T>>(out var parser);
                                               _ = parser;
    ...
    [Fact]
    public async Task ShouldShowErrorWhenAllowsRefStructGenericDelegateArgumentLetIsCapturedByNestedDelegate()
    {
        // Given
        ...
        result.Success.ShouldBeFalse(result);
        result.Errors.Count(i => i.Id == LogId.ErrorStackOnlyDelegateCapture).ShouldBe(1, result);
        result.Errors.Count(i => i is { Id: LogId.ErrorStackOnlyDelegateCapture } && i.Locations.FirstOrDefault().GetSource() == "Let<T>(text)").ShouldBe(1, result);
    }

    [Fact]
    public async Task ShouldShowErrorWhenAllowsRefStructGenericDelegateArgumentIsCapturedByReturnedDelegate()
    {
        // Given
    ...
    [Fact]
    public async Task ShouldShowErrorWhenAllowsRefStructGenericDelegateArgumentLetIsCapturedByReturnedDelegate()
    {
        // Given
    ...
    [Fact]
    public async Task ShouldSupportReadOnlySpanArgumentInFuncFactory()
    {
        // Given
                           ...
                           namespace Sample
                           {
                               partial class Composition
                               {
                                   static void Setup() =>
                                       // Resolve = Off
                                       DI.Setup()
                                           .Bind<Func<ReadOnlySpan<char>, int>>().To<Func<ReadOnlySpan<char>, int>>(_ => text => text.Length)
                                           .Root<Func<ReadOnlySpan<char>, int>>("Parse");
                               }
                               ...
                               public class Program
                               {
                                   ...
                                   {
                                       var composition = new Composition();
                                       Console.WriteLine(composition.Parse("Hello".AsSpan()));
                                   }
                               }
                           }
                           """.RunAsync(new Options(
    ...
    [Fact]
    public async Task ShouldSupportDefaultFuncRootWithReadOnlySpanArgument()
    {
        // Given
        ...
        var result = await """
                           ...
                           namespace Sample
                           {
                               ...
                               public class Program
                               {
                                   ...
                                   {
                                       var composition = new Composition();
                                       Console.WriteLine(composition.ParserFactory("Hello".AsSpan()).Initialized);
                                   }
                               }
                           }
                           """.RunAsync(new Options(
    ...
    [Fact]
    public async Task ShouldSupportDefaultFuncWithReadOnlySpanArgumentWhenInjectedIntoHeapType()
    {
        // Given
        ...
        var result = await """
                           ...
                           namespace Sample
                           {
                               ...
                               class Service(Func<ReadOnlySpan<char>, Parser> parserFactory)
                               {
    ...
    [Fact]
    public async Task ShouldSupportDefaultFuncWithReadOnlySpanArgumentWhenInjectedIntoProperty()
    {
        // Given
        ...
        var result = await """
                           ...
                           namespace Sample
                           {
                               ...
                               {
                                   [Ordinal]
                                   public Func<ReadOnlySpan<char>, Parser> ParserFactory { get; set; } = default!;
        ...
        result.Success.ShouldBeTrue(result);
        result.StdOut.ShouldBe(["True"], result);
        result.Errors.Count(i => i.Id == LogId.ErrorStackOnlyFieldOrPropertyInjection).ShouldBe(0, result);
        result.Warnings.Count(i => i.Id == LogId.WarningStackOnlyConstructorInjectionIntoHeapType).ShouldBe(0, result);
        result.Warnings.Count(i => i.Id == LogId.WarningStackOnlyOverrideRequiresLock).ShouldBe(0, result);
    }
