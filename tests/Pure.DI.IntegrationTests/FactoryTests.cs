...
public class FactoryTests
{
    ...
    [Fact]
    public async Task ShouldSupportInjectWhenTypeInArg()
    {
        // Given
                              ...
                              static class Setup
                              {
                                  private static void SetupComposition()
                                  {
                                      DI.Setup("Composition")
                                          .Bind<IDependency>("my tag").To(ctx => new Dependency())
                                          .Bind<IService>().To(ctx => {
                                              ctx.Inject("my tag", out IDependency dependency);
                                              return new Service(dependency);
                                          })
                                          .Root<IService>("Service");
                                  }
    ...
    [Fact]
    public async Task ShouldSupportInjectWhenTypeAliasInArg()
    {
        // Given
        ...
        var result = await """
                           ...
                           namespace Sample
                           {
                              using IDep = Abc.IDependency;
                           
                              class Dependency: IDep {}
                              ...
                              static class Setup
                              {
                                  ...
                                  {
                                      DI.Setup("Composition")
                                          .Bind<IDep>("my tag").To(ctx => new Dependency())
                                          .Bind<IService>().To(ctx => {
                                              ctx.Inject("my tag", out IDep dependency);
                                              return new Service(dependency);
                                          })
                                          .Root<IService>("Service");
                                  }
    ...
    [Fact]
    public async Task ShouldSupportInjectWhenGlobalTypeAlias()
    {
        // Given

        // When
        var result = await """
                           global using IDep = Abc.IDependency;
                           using System;
                           using Pure.DI;
    ...
    [Fact]
    public async Task ShouldSupportInjectWhenTypeAlias()
    {
        // Given
        ...
        var result = await """
                           ...
                           namespace Sample
                           {
                              ...
                              static class Setup
                              {
                                  ...
                                  {
                                      DI.Setup("Composition")
                                          .Bind<IDep>().To<Dependency>()
                                          .Bind<IService>().To(ctx => {
                                              ctx.Inject(out IDep dependency);
                                              return new Service(dependency);
                                          })
                                          .Root<IService>("Service");
                                  }
    ...
    [Fact]
    public async Task ShouldSupportInjectWhenMultipleTypeAliases()
    {
        // Given
        ...
        var result = await """
                           ...
                           namespace Sample
                           {
                              using IDep1 = Abc.IDependency;
                              using IDep2 = Abc.IDependency;
                           
                              class Dependency: IDep1 {}
                              ...
                              static class Setup
                              {
                                  ...
                                  {
                                      DI.Setup("Composition")
                                          .Bind<Abc.IDependency>("my tag").To(ctx => new Dependency())
                                          .Bind<IService>().To(ctx => {
                                              ctx.Inject("my tag", out IDep1 dependency1);
                                              ctx.Inject("my tag", out IDep2 dependency2);
                              ...
                              public class Program
                              {
                                  public static void Main()
                                  {
                                      var composition = new Composition();
                                      var service = composition.Service;
                                      Console.WriteLine(service.Dep1 != null && service.Dep2 != null);
                                  }
                              }
                           }
                           """.RunAsync();
    ...
    [Fact]
    public async Task ShouldSupportInjectWhenTypeAliasForGenericType()
    {
        // Given
    ...
    [Fact]
    public async Task ShouldSupportInjectWhenTypeAliasInNestedNamespace()
    {
        // Given
        ...
        var result = await """
                           ...
                           namespace Sample
                           {
                              using IDep = Abc.Def.Ghi.IDependency;
    ...
    [Fact]
    public async Task ShouldSupportInjectWithVarWhenTypeAlias()
    {
        // Given
                              ...
                              static class Setup
                              {
                                  private static void SetupComposition()
                                  {
                                      DI.Setup("Composition")
                                          .Bind<IDep>("my tag").To(ctx => new Dependency())
                                          .Bind<IService>().To(ctx => {
                                              ctx.Inject<IDep>("my tag", out var dependency);
                                              return new Service(dependency);
                                          })
                                          .Root<IService>("Service");
                                  }
