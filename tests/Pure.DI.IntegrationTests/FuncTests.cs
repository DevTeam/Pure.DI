...
public class FuncTests
{
    ...
    public async Task ShouldShowWarningWhenStdFuncOverrideClassArg()
    {
        ...
        result.Warnings.Count(i => i.Id == LogId.WarningBindingNotUsed && i.Locations.FirstOrDefault().GetSource() == "Arg<string>(\"str\")").ShouldBe(1, result);
        result.StdOut.ShouldBe(["Xyz Sample.Context`1[System.Int32]"], result);
    }
    ...
    public async Task ShouldShowWarningWhenStdFuncOverrideRootArg()
    {
        ...
        result.Errors.Count.ShouldBe(0, result);
        result.Warnings.Count.ShouldBe(1, result);
        result.Warnings.Count(i => i.Id == LogId.WarningBindingNotUsed && i.Locations.FirstOrDefault().GetSource() == "RootArg<string>(\"str\")").ShouldBe(1, result);
        result.StdOut.ShouldBe(["Xyz Sample.Context`1[System.Int32]"], result);
    }
    ...
    public async Task ShouldSupportFuncWithArgWhenOverrideValueIsNotUsed()
    {
        ...
        result.Errors.Count.ShouldBe(0, result);
        result.Warnings.Count.ShouldBe(1, result);
        result.Warnings.Count(i => i.Id == LogId.WarningBindingNotUsed && i.Locations.FirstOrDefault().GetSource() == "To<Metronome>()").ShouldBe(1, result);
    }
#endif
    [Fact]
