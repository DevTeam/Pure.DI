...
public class Generator
{
    ...
    public Generator(IOptions options, ISourcesRegistry sourcesRegistry, IDiagnostic diagnostic) =>
        _composition = new Composition(options: options, producer: sourcesRegistry, diagnostic: diagnostic);
