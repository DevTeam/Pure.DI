...
internal class ClassBuilder : IBuilder<CompositionCode, CompositionCode>
{
    ...
    public CompositionCode Build(CompositionCode composition, CancellationToken cancellationToken)
    {
        ...
        code.AppendLine("#pragma warning disable CS8618");
        code.AppendLine("#pragma warning disable CS8625");
        code.AppendLine();
        ...
        var implementingInterfaces = composition.Singletons.Any() ? $": {CodeConstants.IDisposableInterfaceName}" : "";
