    ...
    : IBuilder<TagContext, IEnumerable<TagCode>>
{
    ...
    private delegate void Commenter<in TContext>(SmartTag tag, LinesBuilder code, TContext context);
    ...
    private static void DoesNotAddComments(SmartTag tag, LinesBuilder code, Unit context)
    {
    }
