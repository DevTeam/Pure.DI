        ...
        private static void Setup()
        {
            NS35EBD81B.DI.Setup("AspNetFeature")
                .Bind<System.IServiceProvider>()
                    .To(ctx => NS35EBD81B.ServiceProviderInstance.ServiceProvider != null ? NS35EBD81B.ServiceProviderInstance.ServiceProvider: new NS35EBD81B.DefaultServiceProvider(type => Resolve(type)))
