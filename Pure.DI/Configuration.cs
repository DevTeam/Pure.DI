...
internal class Configuration : IoC.IConfiguration
{
    public IEnumerable<IToken> Apply(IMutableContainer container)
    {
        ...
        yield return container
            ...
            .Bind<IMembersBuilder>().Bind<IStatementsFinalizer>().Tag(ResolveContext).To<ResolveContextMembersBuilder>()
        ...
        yield return container
            ...
            .Bind<IStatementsFinalizer>().Bind<IMembersBuilder>().To<StatementsFinalizerMembersBuilder>()
