...
/// <item>
/// <term>
/// <see cref="Pure.DI.UsageTests.Basics.CheckForRootScenario.IService"/> Root
/// </term>
/// <description>
...
/// <item>
/// <term>
/// <see cref="Pure.DI.UsageTests.Basics.CheckForRootScenario.IDependency"/> is a private composition root that can be resolved by methods like <see cref="Resolve{T}()"/>.
/// </term>
/// <description>
...
/// </code>
/// </example>
/// <a href="https://mermaid.live/view#pako:eNqdU71uwjAQfhXLcweTDGnZIKESAwvN6MUkJ2pK4shxkSLEO_AuXfo6vEljOxAnpKTqcrLv57vvvtMdcSJSwFOc7FlZRpxtJcuopLn5o1BkhSi54iJH9JOQYK5j-uXNl28gDzwBtBZC3dzRMoIC8hTypDKRFfGjiZdyQsikLUYxWkMp9ge4nL_jy_nLuJ-NfRlNE5sdJEq__Vek2PauzCZca21RXBWAVG3-kR2ixy2DSL-cya0WrQ1CU7pArjzGNUMUr6raSzFqhe9lubq3oSHNLJPran6n4WZoDrfObsBt2_iH9-RO5fDrcLLw_fnbFr7lFrJNqSRrtF40dghpmOnfYToizVypUF__zpbcGTRO_0g8083aWupHUGPHMgLdW-LdReInnIHMGE_rCz9SrN4hA4qnFKdMflB8wqcfY5pWUA">Class diagram</a><br/>
...
partial class Composition
{
  ...
  public Pure.DI.UsageTests.Basics.CheckForRootScenario.IDependency RootM03D12di0001
  {
    #if NETSTANDARD2_0_OR_GREATER || NETCOREAPP || NET40_OR_GREATER || NET
    [global::System.Diagnostics.Contracts.Pure]
    #endif
  ...
  static Composition()
  {
    ...
    OnNewRoot<Pure.DI.UsageTests.Basics.CheckForRootScenario.IService, Pure.DI.UsageTests.Basics.CheckForRootScenario.Service>(valResolverM03D12di_0000, "Root", null, Pure.DI.Lifetime.Transient);
    ResolverM03D12di<Pure.DI.UsageTests.Basics.CheckForRootScenario.IService>.Value = valResolverM03D12di_0000;
    var valResolverM03D12di_0001 = new ResolverM03D12di_0001();
    OnNewRoot<Pure.DI.UsageTests.Basics.CheckForRootScenario.IDependency, Pure.DI.UsageTests.Basics.CheckForRootScenario.Dependency>(valResolverM03D12di_0001, "RootM03D12di0001", "MyDep", Pure.DI.Lifetime.Transient);
    ResolverM03D12di<Pure.DI.UsageTests.Basics.CheckForRootScenario.IDependency>.Value = valResolverM03D12di_0001;
    _bucketsM03D12di = global::Pure.DI.Buckets<global::System.Type, global::Pure.DI.IResolver<Composition, object>>.Create(
      ...
      {
         new global::Pure.DI.Pair<global::System.Type, global::Pure.DI.IResolver<Composition, object>>(typeof(Pure.DI.UsageTests.Basics.CheckForRootScenario.IService), valResolverM03D12di_0000)
        ,new global::Pure.DI.Pair<global::System.Type, global::Pure.DI.IResolver<Composition, object>>(typeof(Pure.DI.UsageTests.Basics.CheckForRootScenario.IDependency), valResolverM03D12di_0001)
      });
  }
  ...
  private sealed class ResolverM03D12di_0000: global::Pure.DI.IResolver<Composition, Pure.DI.UsageTests.Basics.CheckForRootScenario.IService>
  {
  ...
  private sealed class ResolverM03D12di_0001: global::Pure.DI.IResolver<Composition, Pure.DI.UsageTests.Basics.CheckForRootScenario.IDependency>
  {
