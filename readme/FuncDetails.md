...
partial class Func
{
  ...
  public Pure.DI.Benchmarks.Model.ICompositionRoot Root
  {
    ...
    get
    {
      var perResolveM10D07di25 = default(System.Func<Pure.DI.Benchmarks.Model.IService3>);
      if (object.ReferenceEquals(perResolveM10D07di25, null))
      {
          perResolveM10D07di25 = new global::System.Func<Pure.DI.Benchmarks.Model.IService3>(() =>
          {
              Pure.DI.Benchmarks.Model.IService3 value;
              var transientM10D07di7 = new Pure.DI.Benchmarks.Model.Service3();
              value = transientM10D07di7;
              return value;
          });
      }
      var transientM10D07di6 = new Pure.DI.Benchmarks.Model.Service2Func(perResolveM10D07di25);
      var transientM10D07di5 = new Pure.DI.Benchmarks.Model.Service3();
      var transientM10D07di4 = new Pure.DI.Benchmarks.Model.Service2Func(perResolveM10D07di25);
      var transientM10D07di3 = new Pure.DI.Benchmarks.Model.Service2Func(perResolveM10D07di25);
      var transientM10D07di2 = new Pure.DI.Benchmarks.Model.Service2Func(perResolveM10D07di25);
  ...
  private readonly static global::Pure.DI.Pair<global::System.Type, global::Pure.DI.IResolver<Func, object>>[] _bucketsM10D07di;
  ...
  static Func()
  {
    ...
    _bucketsM10D07di = global::Pure.DI.Buckets<global::System.Type, global::Pure.DI.IResolver<Func, object>>.Create(
      1,
      out _bucketSizeM10D07di,
      new global::Pure.DI.Pair<global::System.Type, global::Pure.DI.IResolver<Func, object>>[1]
      {
         new global::Pure.DI.Pair<global::System.Type, global::Pure.DI.IResolver<Func, object>>(typeof(Pure.DI.Benchmarks.Model.ICompositionRoot), valResolverM10D07di_0000)
      });
  }
  
  #region Resolvers
  private sealed class ResolverM10D07di<T>: global::Pure.DI.IResolver<Func, T>
  {
    public static global::Pure.DI.IResolver<Func, T> Value = new ResolverM10D07di<T>();
  ...
  private sealed class ResolverM10D07di_0000: global::Pure.DI.IResolver<Func, Pure.DI.Benchmarks.Model.ICompositionRoot>
  {
    [global::System.Runtime.CompilerServices.MethodImpl((global::System.Runtime.CompilerServices.MethodImplOptions)0x300)]
