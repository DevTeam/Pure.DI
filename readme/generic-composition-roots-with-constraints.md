...
partial class Composition
{
  ...
  {
    SpecializedDataProcessor<T2> transientSpecializedDataProcessorTTDisposable;
    IStreamSource<T2> localSource = new StreamSource<T2>();
    transientSpecializedDataProcessorTTDisposable = new SpecializedDataProcessor<T2>(localSource);
    return transientSpecializedDataProcessorTTDisposable;
  }
