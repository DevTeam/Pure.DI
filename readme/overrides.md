...
partial class Composition
{
  ...
  public IDashboard Dashboard
  {
    ...
    get
    {
      Func<int, int, IWidget> transientFunc310 =
      [MethodImpl(MethodImplOptions.AggressiveInlining)]
      (localWidgetId, localLayerIndex) =>
      {
        ...
        Drawing.Color transientColor311 = Color.Red;
        Drawing.Color localColor = transientColor311;
        // Overrides the 'color' argument with the resolved value
        // Creates the instance using the overridden values
      ...
      return new Dashboard(transientFunc310);
    }
  }
}
```
