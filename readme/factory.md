...
/// <item>
/// <term>
/// <see cref="Pure.DI.UsageTests.Basics.FactoryScenario.IService"/> <see cref="Root"/><br/>or using <see cref="Resolve{T}()"/> method: <c>Resolve&lt;Pure.DI.UsageTests.Basics.FactoryScenario.IService&gt;()</c>
/// </term>
/// <description>
/// Provides a composition root of type <see cref="Pure.DI.UsageTests.Basics.FactoryScenario.Service"/>.
/// </description>
/// </item>
/// </list>
/// </para>
...
/// </code>
/// </example>
/// <a href="https://mermaid.live/view#pako:eNqdU0tugzAQvYrldaVGsKDNLoFUyjZl6Y3Bo9RNjJFxkaIod8hduul1cpNiG2RD6UfdjMzMmzdvns0Zl5IBXuLySJsm43SvqCCKVPYbpVLUsuGaywqRt8UiWZuaOUXr7TOolpeAdlJqn0Y52kEjjy3crh_57fpu0w82Pv4Kk8UrlNqc4yek6f5LmwMMva4pP9WAdBf-gU7RzyOTzJwyqKFiUJUna0OU-ZiktnWDthNQvELeSF8zucG577lCxIgoLIS30efdiqEU5ifPLOZIp9I9cewUpbRotKK9TZs-zjHN6_s7zciaVWgQCkwcfAmEm-bpc43sCBc7Vyemjh-w1Vcocu_AtZItZ-A3Mvz4DgtQgnLW_TFngvULCCB4STCj6kDwBV8-AZ8nH4w">Class diagram</a><br/>
...
partial class Composition
{
  ...
  /// </summary>
  /// <example>
  /// This shows how to get an instance of type <see cref="Pure.DI.UsageTests.Basics.FactoryScenario.Service"/>:
  /// <code>
  /// var composition = new Composition();
  /// var instance = composition.Root;
  /// </code>
  ...
  public Pure.DI.UsageTests.Basics.FactoryScenario.IService Root
  {
    ...
    get
    {
      Pure.DI.UsageTests.Basics.FactoryScenario.Dependency transientM03D14di1_Dependency;
      {
          var dependency_M03D14di1 = new Dependency(DateTimeOffset.Now);
          dependency_M03D14di1.Initialize();
          transientM03D14di1_Dependency = dependency_M03D14di1;
      }
      return new Pure.DI.UsageTests.Basics.FactoryScenario.Service(transientM03D14di1_Dependency);
    }
  }
  #endregion
  ...
  static Composition()
  {
    ...
    ResolverM03D14di<Pure.DI.UsageTests.Basics.FactoryScenario.IService>.Value = valResolverM03D14di_0000;
    _bucketsM03D14di = global::Pure.DI.Buckets<global::System.Type, global::Pure.DI.IResolver<Composition, object>>.Create(
      ...
      {
         new global::Pure.DI.Pair<global::System.Type, global::Pure.DI.IResolver<Composition, object>>(typeof(Pure.DI.UsageTests.Basics.FactoryScenario.IService), valResolverM03D14di_0000)
      });
  }
  ...
  private sealed class ResolverM03D14di_0000: global::Pure.DI.IResolver<Composition, Pure.DI.UsageTests.Basics.FactoryScenario.IService>
  {
