...
partial class Composition
{
  ...
  public Pure.DI.UsageTests.Basics.FactoryScenario.IService Root
  {
    get
    {
      ...
      {
          var dependency_M03D20di1 = new Dependency(DateTimeOffset.Now);
          dependency_M03D20di1.Initialize();
          transientM03D20di1_Dependency = dependency_M03D20di1;
      }
      return new Pure.DI.UsageTests.Basics.FactoryScenario.Service(transientM03D20di1_Dependency);
    }
  }
  ...
  static Composition()
  {
    ...
    ResolverM03D20di<Pure.DI.UsageTests.Basics.FactoryScenario.IService>.Value = valResolverM03D20di_0000;
    _bucketsM03D20di = global::Pure.DI.Buckets<global::System.Type, global::Pure.DI.IResolver<Composition, object>>.Create(
      ...
      {
         new global::Pure.DI.Pair<global::System.Type, global::Pure.DI.IResolver<Composition, object>>(typeof(Pure.DI.UsageTests.Basics.FactoryScenario.IService), valResolverM03D20di_0000)
      });
  }
  ...
  private sealed class ResolverM03D20di_0000: global::Pure.DI.IResolver<Composition, Pure.DI.UsageTests.Basics.FactoryScenario.IService>
  {
