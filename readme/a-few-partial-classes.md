...
partial class Composition
{
  ...
  public Pure.DI.UsageTests.Basics.SeveralPartialClassesScenario.IService Root
  {
    ...
    get
    {
      var transientM08D05di1 = new Pure.DI.UsageTests.Basics.SeveralPartialClassesScenario.Dependency();
      var transientM08D05di0 = new Pure.DI.UsageTests.Basics.SeveralPartialClassesScenario.Service(transientM08D05di1);
