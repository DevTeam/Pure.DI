...
partial class Composition
{
  ...
  private Pure.DI.UsageTests.Hints.OnNewInstanceHintScenario.Dependency _singletonM02D07di34_Dependency;
    ...
    get
    {
      if (object.ReferenceEquals(_singletonM02D07di34_Dependency, null))
      {
          lock (_disposableSingletonsM02D07di)
          {
              if (object.ReferenceEquals(_singletonM02D07di34_Dependency, null))
              {
                  Pure.DI.UsageTests.Hints.OnNewInstanceHintScenario.Dependency _singletonM02D07di34_DependencyTemp;
                  _singletonM02D07di34_DependencyTemp = new Pure.DI.UsageTests.Hints.OnNewInstanceHintScenario.Dependency();
                  OnNewInstance<Pure.DI.UsageTests.Hints.OnNewInstanceHintScenario.Dependency>(ref _singletonM02D07di34_DependencyTemp, null, Pure.DI.Lifetime.Singleton);
                  global::System.Threading.Thread.MemoryBarrier();
                  _singletonM02D07di34_Dependency = _singletonM02D07di34_DependencyTemp;
              }
          }
      }
      var transientM02D07di0_Service = new Pure.DI.UsageTests.Hints.OnNewInstanceHintScenario.Service(_singletonM02D07di34_Dependency);
      OnNewInstance<Pure.DI.UsageTests.Hints.OnNewInstanceHintScenario.Service>(ref transientM02D07di0_Service, null, Pure.DI.Lifetime.Transient);
      return transientM02D07di0_Service;
    }
  }
  #endregion
  ...
  static Composition()
  {
    ...
    ResolverM02D07di<Pure.DI.UsageTests.Hints.OnNewInstanceHintScenario.IService>.Value = valResolverM02D07di_0000;
    _bucketsM02D07di = global::Pure.DI.Buckets<global::System.Type, global::Pure.DI.IResolver<Composition, object>>.Create(
      ...
      {
         new global::Pure.DI.Pair<global::System.Type, global::Pure.DI.IResolver<Composition, object>>(typeof(Pure.DI.UsageTests.Hints.OnNewInstanceHintScenario.IService), valResolverM02D07di_0000)
      });
  }
  ...
  private sealed class ResolverM02D07di_0000: global::Pure.DI.IResolver<Composition, Pure.DI.UsageTests.Hints.OnNewInstanceHintScenario.IService>
  {
