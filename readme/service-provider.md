...
classDiagram
  class ServiceProvider {
    -IDependency RootM01D20di0001
    -IService RootM01D20di0002
    + T ResolveᐸTᐳ()
  ...
  ServiceProvider ..> Dependency : IDependency RootM01D20di0001
  ServiceProvider ..> Service : IService RootM01D20di0002
```
...
partial class ServiceProvider
{
  ...
  private Pure.DI.UsageTests.BCL.ServiceProviderScenario.Dependency _singletonM01D20di34_Dependency;
  ...
  {
    _disposableSingletonsM01D20di = new global::System.IDisposable[0];
    lock (parent._disposableSingletonsM01D20di)
    {
      _singletonM01D20di34_Dependency = parent._singletonM01D20di34_Dependency;
    }
  }
  
  #region Composition Roots
  public Pure.DI.UsageTests.BCL.ServiceProviderScenario.IDependency RootM01D20di0001
  {
    ...
    get
    {
      if (object.ReferenceEquals(_singletonM01D20di34_Dependency, null))
      {
          lock (_disposableSingletonsM01D20di)
          {
              if (object.ReferenceEquals(_singletonM01D20di34_Dependency, null))
              {
                  _singletonM01D20di34_Dependency = new Pure.DI.UsageTests.BCL.ServiceProviderScenario.Dependency();
              }
          }
      }
      return _singletonM01D20di34_Dependency;
    }
  }
  
  public Pure.DI.UsageTests.BCL.ServiceProviderScenario.IService RootM01D20di0002
  {
    #if NETSTANDARD2_0_OR_GREATER || NETCOREAPP || NET40_OR_GREATER || NET
    [global::System.Diagnostics.Contracts.Pure]
    #endif
    get
    {
      ...
      return new Pure.DI.UsageTests.BCL.ServiceProviderScenario.Service(_singletonM01D20di34_Dependency);
    }
  }
  #endregion
  ...
  private readonly static global::Pure.DI.Pair<global::System.Type, global::Pure.DI.IResolver<ServiceProvider, object>>[] _bucketsM01D20di;
  
  static ServiceProvider()
  {
    var valResolverM01D20di_0000 = new ResolverM01D20di_0000();
    ResolverM01D20di<Pure.DI.UsageTests.BCL.ServiceProviderScenario.IDependency>.Value = valResolverM01D20di_0000;
    var valResolverM01D20di_0001 = new ResolverM01D20di_0001();
    ResolverM01D20di<Pure.DI.UsageTests.BCL.ServiceProviderScenario.IService>.Value = valResolverM01D20di_0001;
    _bucketsM01D20di = global::Pure.DI.Buckets<global::System.Type, global::Pure.DI.IResolver<ServiceProvider, object>>.Create(
      4,
      out _bucketSizeM01D20di,
      new global::Pure.DI.Pair<global::System.Type, global::Pure.DI.IResolver<ServiceProvider, object>>[2]
      {
         new global::Pure.DI.Pair<global::System.Type, global::Pure.DI.IResolver<ServiceProvider, object>>(typeof(Pure.DI.UsageTests.BCL.ServiceProviderScenario.IDependency), valResolverM01D20di_0000)
        ,new global::Pure.DI.Pair<global::System.Type, global::Pure.DI.IResolver<ServiceProvider, object>>(typeof(Pure.DI.UsageTests.BCL.ServiceProviderScenario.IService), valResolverM01D20di_0001)
      });
  }
  
  #region Resolvers
  private sealed class ResolverM01D20di<T>: global::Pure.DI.IResolver<ServiceProvider, T>
  {
    public static global::Pure.DI.IResolver<ServiceProvider, T> Value = new ResolverM01D20di<T>();
  ...
  private sealed class ResolverM01D20di_0000: global::Pure.DI.IResolver<ServiceProvider, Pure.DI.UsageTests.BCL.ServiceProviderScenario.IDependency>
  {
    public Pure.DI.UsageTests.BCL.ServiceProviderScenario.IDependency Resolve(ServiceProvider composition)
    {
      return composition.RootM01D20di0001;
    }
  ...
  private sealed class ResolverM01D20di_0001: global::Pure.DI.IResolver<ServiceProvider, Pure.DI.UsageTests.BCL.ServiceProviderScenario.IService>
  {
    public Pure.DI.UsageTests.BCL.ServiceProviderScenario.IService Resolve(ServiceProvider composition)
    {
      return composition.RootM01D20di0002;
    }
