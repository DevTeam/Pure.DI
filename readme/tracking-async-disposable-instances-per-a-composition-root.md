...
partial class Composition
{
  ...
  public Pure.DI.Owned<Pure.DI.UsageTests.Basics.TrackingAsyncDisposableScenario.IService> Root
  {
    ...
    get
    {
      ...
      Pure.DI.UsageTests.Basics.TrackingAsyncDisposableScenario.Dependency transientM04D27di3_Dependency = new Pure.DI.UsageTests.Basics.TrackingAsyncDisposableScenario.Dependency();
      lock (_lockM04D27di)
      {
          accumulatorM04D27di38.Add(transientM04D27di3_Dependency);
      }
      Pure.DI.Owned<Pure.DI.UsageTests.Basics.TrackingAsyncDisposableScenario.IService> perBlockM04D27di0_Owned;
      {
          var owned_M04D27di1 = accumulatorM04D27di38;
          var value_M04D27di2 = new Pure.DI.UsageTests.Basics.TrackingAsyncDisposableScenario.Service(transientM04D27di3_Dependency);
          perBlockM04D27di0_Owned = new Owned<Pure.DI.UsageTests.Basics.TrackingAsyncDisposableScenario.IService>(value_M04D27di2, owned_M04D27di1);
      }
      lock (_lockM04D27di)
      {
