...
partial class Composition
{
  public IShop MyShop
  {
    ...
    get
    {
      var perBlockOrderManager337 = new OrderManager(new OrderNameFormatter());
      return new Shop(perBlockOrderManager337, perBlockOrderManager337, perBlockOrderManager337);
    }
  }
}
```
