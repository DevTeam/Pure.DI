...
partial class Composition
{
  public IShop MyShop
  {
    ...
    get
    {
      var perBlockOrderManager350 = new OrderManager(new OrderNameFormatter());
      return new Shop(perBlockOrderManager350, perBlockOrderManager350, perBlockOrderManager350);
    }
  }
}
```
