...
partial class Composition
{
  ...
  private readonly string _argM12D06diserviceName;
  ...
  public Composition(string serviceName)
  {
    ...
    _argM12D06diserviceName = serviceName;
  ...
  {
    _disposableSingletonsM12D06di = new global::System.IDisposable[0];
    _argM12D06diserviceName = parent._argM12D06diserviceName;
  }
  ...
  public Pure.DI.UsageTests.Basics.InstanceInitializationScenario.IService Root
  {
    ...
    get
    {
      Pure.DI.UsageTests.Basics.InstanceInitializationScenario.Service transientM12D06di0;
      {
          var service = new Pure.DI.UsageTests.Basics.InstanceInitializationScenario.Service(_argM12D06diserviceName, new Pure.DI.UsageTests.Basics.InstanceInitializationScenario.Dependency());
          // Executing all the necessary logic
          // to prepare the instance for further use
          service.Initialize();
          transientM12D06di0 = service;
      }
  ...
  static Composition()
  {
    ...
    ResolverM12D06di<Pure.DI.UsageTests.Basics.InstanceInitializationScenario.IService>.Value = valResolverM12D06di_0000;
    _bucketsM12D06di = global::Pure.DI.Buckets<global::System.Type, global::Pure.DI.IResolver<Composition, object>>.Create(
      ...
      {
         new global::Pure.DI.Pair<global::System.Type, global::Pure.DI.IResolver<Composition, object>>(typeof(Pure.DI.UsageTests.Basics.InstanceInitializationScenario.IService), valResolverM12D06di_0000)
      });
  }
  ...
  private sealed class ResolverM12D06di_0000: global::Pure.DI.IResolver<Composition, Pure.DI.UsageTests.Basics.InstanceInitializationScenario.IService>
  {
