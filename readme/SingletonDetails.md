...
partial class Singleton
{
  ...
  private Pure.DI.Benchmarks.Model.Service1 _singletonM12D01di21;
  ...
  public partial Pure.DI.Benchmarks.Model.CompositionRoot PureDIByCR()
  {
    ...
    {
        _singletonM12D01di21 = new Pure.DI.Benchmarks.Model.Service1(new Pure.DI.Benchmarks.Model.Service2(new Pure.DI.Benchmarks.Model.Service3(), new Pure.DI.Benchmarks.Model.Service3(), new Pure.DI.Benchmarks.Model.Service3(), new Pure.DI.Benchmarks.Model.Service3(), new Pure.DI.Benchmarks.Model.Service3()));
    }
    return new Pure.DI.Benchmarks.Model.CompositionRoot(_singletonM12D01di21, new Pure.DI.Benchmarks.Model.Service2(new Pure.DI.Benchmarks.Model.Service3(), new Pure.DI.Benchmarks.Model.Service3(), new Pure.DI.Benchmarks.Model.Service3(), new Pure.DI.Benchmarks.Model.Service3(), new Pure.DI.Benchmarks.Model.Service3()), new Pure.DI.Benchmarks.Model.Service2(new Pure.DI.Benchmarks.Model.Service3(), new Pure.DI.Benchmarks.Model.Service3(), new Pure.DI.Benchmarks.Model.Service3(), new Pure.DI.Benchmarks.Model.Service3(), new Pure.DI.Benchmarks.Model.Service3()), new Pure.DI.Benchmarks.Model.Service2(new Pure.DI.Benchmarks.Model.Service3(), new Pure.DI.Benchmarks.Model.Service3(), new Pure.DI.Benchmarks.Model.Service3(), new Pure.DI.Benchmarks.Model.Service3(), new Pure.DI.Benchmarks.Model.Service3()), new Pure.DI.Benchmarks.Model.Service3());
  }
  #endregion
  ...
  private readonly static global::Pure.DI.Pair<global::System.Type, global::Pure.DI.IResolver<Singleton, object>>[] _bucketsM12D01di;
  ...
  static Singleton()
  {
    ...
    _bucketsM12D01di = global::Pure.DI.Buckets<global::System.Type, global::Pure.DI.IResolver<Singleton, object>>.Create(
      1,
      out _bucketSizeM12D01di,
      new global::Pure.DI.Pair<global::System.Type, global::Pure.DI.IResolver<Singleton, object>>[1]
      {
         new global::Pure.DI.Pair<global::System.Type, global::Pure.DI.IResolver<Singleton, object>>(typeof(Pure.DI.Benchmarks.Model.CompositionRoot), valResolverM12D01di_0000)
      });
  }
  
  #region Resolvers
  private sealed class ResolverM12D01di<T>: global::Pure.DI.IResolver<Singleton, T>
  {
    public static global::Pure.DI.IResolver<Singleton, T> Value = new ResolverM12D01di<T>();
  ...
  private sealed class ResolverM12D01di_0000: global::Pure.DI.IResolver<Singleton, Pure.DI.Benchmarks.Model.CompositionRoot>
  {
