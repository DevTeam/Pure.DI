...
partial class Composition
{
  ...
  public IService Root
  {
    ...
    get
    {
      return OnDependencyInjection<IService>(new Service(OnDependencyInjection<IDependency>(new Dependency(), null, Pure.DI.Lifetime.Transient)), null, Pure.DI.Lifetime.Transient);
    }
  }
