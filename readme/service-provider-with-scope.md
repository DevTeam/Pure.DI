...
/// </list>
/// </para>
/// <a href="https://mermaid.live/view#pako:eNqNVEtuwjAQvcrI6y5MsqBlV2JaoaobYOmNiUfgNompY5AQ4g7cpZteh5s0H2gcNw3djCaZ92ae38Q5kFhLJCMSJyLPmRIrI1JueFY9Q6TTjc6VVToDvqV0OC5rZRawKcMNZhKzeA8zre0rDRkdSEUpHTioOZqditGHBD-QMSxghrlOdng-fS3Op8_q9X0VH27C9PINY1vm4RNYsfpFqwHwjPYipeYt9hsEW4Qewgw_tsqgfME9yh52BP0qhqzMfDMD1sRhVHEnMGUqL1BimWDJcTzuobRB4SM0G_RqzgLHTanL8FrzdXt_D3cRrcluwR3b8tHVLtt6PCV1U_-sTeOwVhSJZW6NuOxicoldnbr1_b_Nla9dbwA4matslaDVGSe-_YVBzgk6P4pqVh0Le3v5ndfuRkNvXb3Xk9yRFE0qlCx-EAdO7BpT5GTEiRTmnZMjOX4DbPJsNA">Class diagram</a><br/>
...
partial class Composition: global::System.IDisposable
{
  ...
  private readonly global::System.IDisposable[] _disposablesM03D01di;
  private int _disposeIndexM03D01di;
  private Pure.DI.UsageTests.BCL.ServiceProviderWithScopeScenario.Dependency _singletonM03D01di34_Dependency;
  private Pure.DI.UsageTests.BCL.ServiceProviderWithScopeScenario.Service _scopedM03D01di35_Service;
  ...
  public Composition()
  {
    ...
    _disposablesM03D01di = new global::System.IDisposable[1];
  }
  ...
  public Pure.DI.UsageTests.BCL.ServiceProviderWithScopeScenario.IDependency RootM03D01di0001
  {
    ...
    get
    {
      if (ReferenceEquals(_rootM03D01di._singletonM03D01di34_Dependency, null))
      {
          lock (_lockM03D01di)
          {
              if (ReferenceEquals(_rootM03D01di._singletonM03D01di34_Dependency, null))
              {
                  _singletonM03D01di34_Dependency = new Pure.DI.UsageTests.BCL.ServiceProviderWithScopeScenario.Dependency();
  ...
  public Pure.DI.UsageTests.BCL.ServiceProviderWithScopeScenario.IService RootM03D01di0002
  {
    #if NETSTANDARD2_0_OR_GREATER || NETCOREAPP || NET40_OR_GREATER || NET
    [global::System.Diagnostics.Contracts.Pure]
    #endif
    get
    {
      if (ReferenceEquals(_scopedM03D01di35_Service, null))
      {
          lock (_lockM03D01di)
          {
              if (ReferenceEquals(_scopedM03D01di35_Service, null))
              {
                  ...
                  _scopedM03D01di35_Service = new Pure.DI.UsageTests.BCL.ServiceProviderWithScopeScenario.Service(_rootM03D01di._singletonM03D01di34_Dependency);
                  _disposablesM03D01di[_disposeIndexM03D01di++] = _scopedM03D01di35_Service;
              }
          }
      }
      return _scopedM03D01di35_Service;
    }
  }
  #endregion
  ...
  public void Dispose()
  {
    lock (_lockM03D01di)
    {
      while (_disposeIndexM03D01di > 0)
      {
        var disposableInstance = _disposablesM03D01di[--_disposeIndexM03D01di];
        try
        {
      ...
      _singletonM03D01di34_Dependency = null;
      _scopedM03D01di35_Service = null;
    }
  }
  ...
  static Composition()
  {
    ...
    ResolverM03D01di<Pure.DI.UsageTests.BCL.ServiceProviderWithScopeScenario.IDependency>.Value = valResolverM03D01di_0000;
    var valResolverM03D01di_0001 = new ResolverM03D01di_0001();
    ResolverM03D01di<Pure.DI.UsageTests.BCL.ServiceProviderWithScopeScenario.IService>.Value = valResolverM03D01di_0001;
    _bucketsM03D01di = global::Pure.DI.Buckets<global::System.Type, global::Pure.DI.IResolver<Composition, object>>.Create(
      ...
      {
         new global::Pure.DI.Pair<global::System.Type, global::Pure.DI.IResolver<Composition, object>>(typeof(Pure.DI.UsageTests.BCL.ServiceProviderWithScopeScenario.IDependency), valResolverM03D01di_0000)
        ,new global::Pure.DI.Pair<global::System.Type, global::Pure.DI.IResolver<Composition, object>>(typeof(Pure.DI.UsageTests.BCL.ServiceProviderWithScopeScenario.IService), valResolverM03D01di_0001)
      });
  }
  ...
  private sealed class ResolverM03D01di_0000: global::Pure.DI.IResolver<Composition, Pure.DI.UsageTests.BCL.ServiceProviderWithScopeScenario.IDependency>
  {
  ...
  private sealed class ResolverM03D01di_0001: global::Pure.DI.IResolver<Composition, Pure.DI.UsageTests.BCL.ServiceProviderWithScopeScenario.IService>
  {
