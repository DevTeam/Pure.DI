...
classDiagram
  class Composition {
    -IDependency RootM02D26di0001
    -IService RootM02D26di0002
    + T ResolveᐸTᐳ()
  ...
  Composition ..> Dependency : IDependency RootM02D26di0001
  Composition ..> Service : IService RootM02D26di0002
```
...
/// </list>
/// </para>
/// <a href="https://mermaid.live/view#pako:eNqNVEtOwzAQvcrIaxYhlSh0R5KCKsSmzdIbJx4FQxIXx61UVb1D78KG6_Qm5FfiuCFlM3I87808v4m9J7HkSGYkTllRBIIlimVU0bz-Bl9ma1kILWQOdOM4U6_KVSs3WAS4xpxjHu9gKaV-LffcOy4cx7k1UCtUWxGjDXF_IR6EsMRCpls8Hb_D0_Gr3r6v48NVmIzeMdbVevIEmiUXtAYAz6hbKQ0v3K0RdBlGCEv83AiF_AV3yEfYPoyrmAbVyjbTDbo49WvuHBaBKEoUi1KsOIbHI5Q-aPII3QStnDFAr0sNGd5oPk_v7-YmotfZTJhtez6a2nlfj6WkKWqftSs8aRT5LCq0Yu0s5m0cqjSs7_9lznxpegNAyUrkSYpa5pTY9pcGGScY_CnqXk0s7R3lD167KwWtcY1eT3JDMlQZE7x8IPaU6DfMkJIZJZypD0oO5PADn0ZsTA">Class diagram</a><br/>
...
partial class Composition: global::System.IDisposable
{
  ...
  private readonly global::System.IDisposable[] _disposablesM02D26di;
  private int _disposeIndexM02D26di;
  private Pure.DI.UsageTests.BCL.ServiceProviderWithScopeScenario.Dependency _singletonM02D26di34_Dependency;
  private Pure.DI.UsageTests.BCL.ServiceProviderWithScopeScenario.Service _scopedM02D26di35_Service;
  ...
  public Composition()
  {
    ...
    _disposablesM02D26di = new global::System.IDisposable[1];
  }
  ...
  public Pure.DI.UsageTests.BCL.ServiceProviderWithScopeScenario.IDependency RootM02D26di0001
  {
    ...
    get
    {
      if (ReferenceEquals(_rootM02D26di._singletonM02D26di34_Dependency, null))
      {
          lock (_lockM02D26di)
          {
              if (ReferenceEquals(_rootM02D26di._singletonM02D26di34_Dependency, null))
              {
                  _singletonM02D26di34_Dependency = new Pure.DI.UsageTests.BCL.ServiceProviderWithScopeScenario.Dependency();
                  _rootM02D26di._singletonM02D26di34_Dependency = _singletonM02D26di34_Dependency;
              }
          }
      }
      return _rootM02D26di._singletonM02D26di34_Dependency;
    }
  }
  
  public Pure.DI.UsageTests.BCL.ServiceProviderWithScopeScenario.IService RootM02D26di0002
  {
    #if NETSTANDARD2_0_OR_GREATER || NETCOREAPP || NET40_OR_GREATER || NET
    [global::System.Diagnostics.Contracts.Pure]
    #endif
    get
    {
      if (ReferenceEquals(_scopedM02D26di35_Service, null))
      {
          lock (_lockM02D26di)
          {
              if (ReferenceEquals(_scopedM02D26di35_Service, null))
              {
                  ...
                  _scopedM02D26di35_Service = new Pure.DI.UsageTests.BCL.ServiceProviderWithScopeScenario.Service(_rootM02D26di._singletonM02D26di34_Dependency);
                  _disposablesM02D26di[_disposeIndexM02D26di++] = _scopedM02D26di35_Service;
              }
          }
      }
      return _scopedM02D26di35_Service;
    }
  }
  #endregion
  ...
  public void Dispose()
  {
    lock (_lockM02D26di)
    {
      while (_disposeIndexM02D26di > 0)
      {
        var disposableInstance = _disposablesM02D26di[--_disposeIndexM02D26di];
        try
        {
      ...
      _singletonM02D26di34_Dependency = null;
      _scopedM02D26di35_Service = null;
    }
  }
  ...
  static Composition()
  {
    ...
    ResolverM02D26di<Pure.DI.UsageTests.BCL.ServiceProviderWithScopeScenario.IDependency>.Value = valResolverM02D26di_0000;
    var valResolverM02D26di_0001 = new ResolverM02D26di_0001();
    ResolverM02D26di<Pure.DI.UsageTests.BCL.ServiceProviderWithScopeScenario.IService>.Value = valResolverM02D26di_0001;
    _bucketsM02D26di = global::Pure.DI.Buckets<global::System.Type, global::Pure.DI.IResolver<Composition, object>>.Create(
      ...
      {
         new global::Pure.DI.Pair<global::System.Type, global::Pure.DI.IResolver<Composition, object>>(typeof(Pure.DI.UsageTests.BCL.ServiceProviderWithScopeScenario.IDependency), valResolverM02D26di_0000)
        ,new global::Pure.DI.Pair<global::System.Type, global::Pure.DI.IResolver<Composition, object>>(typeof(Pure.DI.UsageTests.BCL.ServiceProviderWithScopeScenario.IService), valResolverM02D26di_0001)
      });
  }
  ...
  private sealed class ResolverM02D26di_0000: global::Pure.DI.IResolver<Composition, Pure.DI.UsageTests.BCL.ServiceProviderWithScopeScenario.IDependency>
  {
    public Pure.DI.UsageTests.BCL.ServiceProviderWithScopeScenario.IDependency Resolve(Composition composition)
    {
      return composition.RootM02D26di0001;
    }
  ...
  private sealed class ResolverM02D26di_0001: global::Pure.DI.IResolver<Composition, Pure.DI.UsageTests.BCL.ServiceProviderWithScopeScenario.IService>
  {
    public Pure.DI.UsageTests.BCL.ServiceProviderWithScopeScenario.IService Resolve(Composition composition)
    {
      return composition.RootM02D26di0002;
    }
