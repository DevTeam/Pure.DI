...
partial class Enum
{
  ...
  public Pure.DI.Benchmarks.Model.ICompositionRoot Root
  {
    ...
    get
    {
      var perResolveM11D30di28 = default(System.Collections.Generic.IEnumerable<Pure.DI.Benchmarks.Model.IService3>);
      if (object.ReferenceEquals(perResolveM11D30di28, null))
      {
          System.Collections.Generic.IEnumerable<Pure.DI.Benchmarks.Model.IService3> LocalFunc_perResolveM11D30di28()
          {
              yield return new Pure.DI.Benchmarks.Model.Service3();
              yield return new Pure.DI.Benchmarks.Model.Service3v2();
              yield return new Pure.DI.Benchmarks.Model.Service3v3();
              yield return new Pure.DI.Benchmarks.Model.Service3v4();
          }
          perResolveM11D30di28 = LocalFunc_perResolveM11D30di28();
      }
      return new Pure.DI.Benchmarks.Model.CompositionRoot(new Pure.DI.Benchmarks.Model.Service1(new Pure.DI.Benchmarks.Model.Service2Enum(perResolveM11D30di28)), new Pure.DI.Benchmarks.Model.Service2Enum(perResolveM11D30di28), new Pure.DI.Benchmarks.Model.Service2Enum(perResolveM11D30di28), new Pure.DI.Benchmarks.Model.Service2Enum(perResolveM11D30di28), new Pure.DI.Benchmarks.Model.Service3());
    }
  }
  #endregion
  ...
  private readonly static global::Pure.DI.Pair<global::System.Type, global::Pure.DI.IResolver<Enum, object>>[] _bucketsM11D30di;
  ...
  static Enum()
  {
    ...
    _bucketsM11D30di = global::Pure.DI.Buckets<global::System.Type, global::Pure.DI.IResolver<Enum, object>>.Create(
      1,
      out _bucketSizeM11D30di,
      new global::Pure.DI.Pair<global::System.Type, global::Pure.DI.IResolver<Enum, object>>[1]
      {
         new global::Pure.DI.Pair<global::System.Type, global::Pure.DI.IResolver<Enum, object>>(typeof(Pure.DI.Benchmarks.Model.ICompositionRoot), valResolverM11D30di_0000)
      });
  }
  
  #region Resolvers
  private sealed class ResolverM11D30di<T>: global::Pure.DI.IResolver<Enum, T>
  {
    public static global::Pure.DI.IResolver<Enum, T> Value = new ResolverM11D30di<T>();
  ...
  private sealed class ResolverM11D30di_0000: global::Pure.DI.IResolver<Enum, Pure.DI.Benchmarks.Model.ICompositionRoot>
  {
    [global::System.Runtime.CompilerServices.MethodImpl((global::System.Runtime.CompilerServices.MethodImplOptions)0x300)]
