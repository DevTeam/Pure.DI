...
classDiagram
  class Composition {
    -IDependency RootM01D18di0001
    -IService RootM01D18di0002
    + T ResolveᐸTᐳ()
  ...
  Composition ..> Dependency : IDependency RootM01D18di0001
  Composition ..> Service : IService RootM01D18di0002
```
...
partial class Composition
{
  ...
  private Pure.DI.UsageTests.BCL.ServiceCollectionScenario.Dependency _singletonM01D18di34_Dependency;
  ...
  public Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IDependency RootM01D18di0001
  {
    ...
    get
    {
      if (object.ReferenceEquals(_singletonM01D18di34_Dependency, null))
      {
          lock (_disposableSingletonsM01D18di)
          {
              if (object.ReferenceEquals(_singletonM01D18di34_Dependency, null))
              {
                  _singletonM01D18di34_Dependency = new Pure.DI.UsageTests.BCL.ServiceCollectionScenario.Dependency();
              }
          }
      }
  ...
  public Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IService RootM01D18di0002
  {
    #if NETSTANDARD2_0_OR_GREATER || NETCOREAPP || NET40_OR_GREATER || NET
    [global::System.Diagnostics.Contracts.Pure]
    #endif
    get
    {
      ...
      return new Pure.DI.UsageTests.BCL.ServiceCollectionScenario.Service(_singletonM01D18di34_Dependency);
    }
  }
  #endregion
  ...
  {
    var index = (int)(_bucketSizeM01D18di * ((uint)global::System.Runtime.CompilerServices.RuntimeHelpers.GetHashCode(type) % 4));
  ...
  static Composition()
  {
    ...
    OnNewRoot<Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IDependency, Pure.DI.UsageTests.BCL.ServiceCollectionScenario.Dependency>(valResolverM01D18di_0000, "RootM01D18di0001", null, Pure.DI.Lifetime.Singleton);
    ResolverM01D18di<Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IDependency>.Value = valResolverM01D18di_0000;
    var valResolverM01D18di_0001 = new ResolverM01D18di_0001();
    OnNewRoot<Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IService, Pure.DI.UsageTests.BCL.ServiceCollectionScenario.Service>(valResolverM01D18di_0001, "RootM01D18di0002", null, Pure.DI.Lifetime.Transient);
    ResolverM01D18di<Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IService>.Value = valResolverM01D18di_0001;
    _bucketsM01D18di = global::Pure.DI.Buckets<global::System.Type, global::Pure.DI.IResolver<Composition, object>>.Create(
      ...
      {
         new global::Pure.DI.Pair<global::System.Type, global::Pure.DI.IResolver<Composition, object>>(typeof(Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IDependency), valResolverM01D18di_0000)
        ,new global::Pure.DI.Pair<global::System.Type, global::Pure.DI.IResolver<Composition, object>>(typeof(Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IService), valResolverM01D18di_0001)
      });
  }
  ...
  private sealed class ResolverM01D18di_0000: global::Pure.DI.IResolver<Composition, Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IDependency>
  {
    public Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IDependency Resolve(Composition composition)
    {
      return composition.RootM01D18di0001;
    }
  ...
  private sealed class ResolverM01D18di_0001: global::Pure.DI.IResolver<Composition, Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IService>
  {
    public Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IService Resolve(Composition composition)
    {
      return composition.RootM01D18di0002;
    }
