...
partial class Composition
{
  ...
  private Pure.DI.UsageTests.BCL.ServiceCollectionScenario.Dependency _singletonM12D01di21;
  ...
  private Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IDependency RootM12D01di0001
  {
    ...
    get
    {
      if (object.ReferenceEquals(_singletonM12D01di21, null))
      {
          lock (_disposableSingletonsM12D01di)
          {
              if (object.ReferenceEquals(_singletonM12D01di21, null))
              {
                  _singletonM12D01di21 = new Pure.DI.UsageTests.BCL.ServiceCollectionScenario.Dependency();
              }
          }
      }
  ...
  private Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IService RootM12D01di0002
  {
    #if NETSTANDARD2_0_OR_GREATER || NETCOREAPP || NET40_OR_GREATER || NET
    [global::System.Diagnostics.Contracts.Pure]
    #endif
    get
    {
      ...
      return new Pure.DI.UsageTests.BCL.ServiceCollectionScenario.Service(_singletonM12D01di21);
    }
  }
  #endregion
  ...
  static Composition()
  {
    ...
    OnNewRoot<Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IDependency, Pure.DI.UsageTests.BCL.ServiceCollectionScenario.Dependency>(valResolverM12D01di_0000, "RootM12D01di0001", null, Pure.DI.Lifetime.Singleton);
    ResolverM12D01di<Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IDependency>.Value = valResolverM12D01di_0000;
    var valResolverM12D01di_0001 = new ResolverM12D01di_0001();
    OnNewRoot<Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IService, Pure.DI.UsageTests.BCL.ServiceCollectionScenario.Service>(valResolverM12D01di_0001, "RootM12D01di0002", null, Pure.DI.Lifetime.Transient);
    ResolverM12D01di<Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IService>.Value = valResolverM12D01di_0001;
    _bucketsM12D01di = global::Pure.DI.Buckets<global::System.Type, global::Pure.DI.IResolver<Composition, object>>.Create(
      ...
      {
         new global::Pure.DI.Pair<global::System.Type, global::Pure.DI.IResolver<Composition, object>>(typeof(Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IDependency), valResolverM12D01di_0000)
        ,new global::Pure.DI.Pair<global::System.Type, global::Pure.DI.IResolver<Composition, object>>(typeof(Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IService), valResolverM12D01di_0001)
      });
  }
  ...
  private sealed class ResolverM12D01di_0000: global::Pure.DI.IResolver<Composition, Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IDependency>
  {
  ...
  private sealed class ResolverM12D01di_0001: global::Pure.DI.IResolver<Composition, Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IService>
  {
