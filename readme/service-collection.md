...
classDiagram
  ...
  Composition ..> Dependency : "Dependency Key" IDependency RootM03D08di0001
...
/// </list>
/// </para>
/// <a href="https://mermaid.live/view#pako:eNqdVEFugzAQ_Irlcw8uOZDmViCVqqqXhKMvDqyoW7CRcSOhKH_IX3rpd_KTAobgEhpQLyuznt2dnZE54EjGgFc4SllRBJwlimVUUdF8I19muSy45lIg-kmI69V39ckJngPIQcQgohJtpNSvZBGQZcwJIfcWagtqzyMYQpwLxEMh2kAh0z2cT9_h-fTVpJdNfJiEyd07RLo-L56QZslVmQF0taYoLHNAugr_QPvo9kg3qE-WOEaIPrp-U7pGtoJN6hFRbOVeoKQY9W4M4JYZXn81Jp6h1DnxNx8bUZO5TLYv7LFt3sy014l_8xkwMU2H6_eNF4aRz3aFVqyVet3GsU7j_Oa36eqlrQ2q3NhykaSgpaiMmOWWvVXdefiCnGa-iZXks3pOvbSJGQNXb75IfIczUBnjcfVPOFCs3yADilcUx0x9UHzExx-th2bq">Class diagram</a><br/>
...
partial class Composition
{
  ...
  private Pure.DI.UsageTests.BCL.ServiceCollectionScenario.Dependency _singletonM03D08di34_Dependency;
  ...
  public Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IDependency RootM03D08di0001
  {
    ...
    get
    {
      if (ReferenceEquals(_rootM03D08di._singletonM03D08di34_Dependency, null))
      {
          lock (_lockM03D08di)
          {
              if (ReferenceEquals(_rootM03D08di._singletonM03D08di34_Dependency, null))
              {
                  _singletonM03D08di34_Dependency = new Pure.DI.UsageTests.BCL.ServiceCollectionScenario.Dependency();
  ...
  public Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IService RootM03D08di0002
  {
    #if NETSTANDARD2_0_OR_GREATER || NETCOREAPP || NET40_OR_GREATER || NET
    [global::System.Diagnostics.Contracts.Pure]
    #endif
    get
    {
      ...
      return new Pure.DI.UsageTests.BCL.ServiceCollectionScenario.Service(_rootM03D08di._singletonM03D08di34_Dependency);
    }
  }
  #endregion
  ...
  static Composition()
  {
    ...
    OnNewRoot<Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IDependency, Pure.DI.UsageTests.BCL.ServiceCollectionScenario.Dependency>(valResolverM03D08di_0000, "RootM03D08di0001", "Dependency Key", Pure.DI.Lifetime.Singleton);
    ResolverM03D08di<Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IDependency>.Value = valResolverM03D08di_0000;
    var valResolverM03D08di_0001 = new ResolverM03D08di_0001();
    OnNewRoot<Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IService, Pure.DI.UsageTests.BCL.ServiceCollectionScenario.Service>(valResolverM03D08di_0001, "RootM03D08di0002", null, Pure.DI.Lifetime.Transient);
    ResolverM03D08di<Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IService>.Value = valResolverM03D08di_0001;
    _bucketsM03D08di = global::Pure.DI.Buckets<global::System.Type, global::Pure.DI.IResolver<Composition, object>>.Create(
      ...
      {
         new global::Pure.DI.Pair<global::System.Type, global::Pure.DI.IResolver<Composition, object>>(typeof(Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IDependency), valResolverM03D08di_0000)
        ,new global::Pure.DI.Pair<global::System.Type, global::Pure.DI.IResolver<Composition, object>>(typeof(Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IService), valResolverM03D08di_0001)
      });
  }
  ...
  private sealed class ResolverM03D08di_0000: global::Pure.DI.IResolver<Composition, Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IDependency>
  {
  ...
  private sealed class ResolverM03D08di_0001: global::Pure.DI.IResolver<Composition, Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IService>
  {
