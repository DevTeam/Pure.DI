...
classDiagram
  ...
  Composition ..> Dependency : IDependency RootM02D01di0001
  Composition ..> Service : IService RootM02D01di0002
```
...
partial class Composition
{
  ...
  private Pure.DI.UsageTests.BCL.ServiceCollectionScenario.Dependency _singletonM02D01di34_Dependency;
  ...
  public Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IDependency RootM02D01di0001
  {
    ...
    get
    {
      if (object.ReferenceEquals(_singletonM02D01di34_Dependency, null))
      {
          lock (_disposableSingletonsM02D01di)
          {
              if (object.ReferenceEquals(_singletonM02D01di34_Dependency, null))
              {
                  _singletonM02D01di34_Dependency = new Pure.DI.UsageTests.BCL.ServiceCollectionScenario.Dependency();
              }
          }
      }
  ...
  public Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IService RootM02D01di0002
  {
    #if NETSTANDARD2_0_OR_GREATER || NETCOREAPP || NET40_OR_GREATER || NET
    [global::System.Diagnostics.Contracts.Pure]
    #endif
    get
    {
      ...
      return new Pure.DI.UsageTests.BCL.ServiceCollectionScenario.Service(_singletonM02D01di34_Dependency);
    }
  }
  #endregion
  ...
  static Composition()
  {
    ...
    OnNewRoot<Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IDependency, Pure.DI.UsageTests.BCL.ServiceCollectionScenario.Dependency>(valResolverM02D01di_0000, "RootM02D01di0001", null, Pure.DI.Lifetime.Singleton);
    ResolverM02D01di<Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IDependency>.Value = valResolverM02D01di_0000;
    var valResolverM02D01di_0001 = new ResolverM02D01di_0001();
    OnNewRoot<Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IService, Pure.DI.UsageTests.BCL.ServiceCollectionScenario.Service>(valResolverM02D01di_0001, "RootM02D01di0002", null, Pure.DI.Lifetime.Transient);
    ResolverM02D01di<Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IService>.Value = valResolverM02D01di_0001;
    _bucketsM02D01di = global::Pure.DI.Buckets<global::System.Type, global::Pure.DI.IResolver<Composition, object>>.Create(
      ...
      {
         new global::Pure.DI.Pair<global::System.Type, global::Pure.DI.IResolver<Composition, object>>(typeof(Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IDependency), valResolverM02D01di_0000)
        ,new global::Pure.DI.Pair<global::System.Type, global::Pure.DI.IResolver<Composition, object>>(typeof(Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IService), valResolverM02D01di_0001)
      });
  }
  ...
  private sealed class ResolverM02D01di_0000: global::Pure.DI.IResolver<Composition, Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IDependency>
  {
  ...
  private sealed class ResolverM02D01di_0001: global::Pure.DI.IResolver<Composition, Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IService>
  {
