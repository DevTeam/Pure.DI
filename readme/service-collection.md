...
partial class Composition
{
  ...
  private Pure.DI.UsageTests.BCL.ServiceCollectionScenario.Dependency _singletonM01D15di28_Dependency;
  ...
  public Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IDependency RootM01D15di0001
  {
    ...
    get
    {
      if (object.ReferenceEquals(_singletonM01D15di28_Dependency, null))
      {
          lock (_disposableSingletonsM01D15di)
          {
              if (object.ReferenceEquals(_singletonM01D15di28_Dependency, null))
              {
                  _singletonM01D15di28_Dependency = new Pure.DI.UsageTests.BCL.ServiceCollectionScenario.Dependency();
              }
          }
      }
  ...
  public Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IService RootM01D15di0002
  {
    #if NETSTANDARD2_0_OR_GREATER || NETCOREAPP || NET40_OR_GREATER || NET
    [global::System.Diagnostics.Contracts.Pure]
    #endif
    get
    {
      ...
      return new Pure.DI.UsageTests.BCL.ServiceCollectionScenario.Service(_singletonM01D15di28_Dependency);
    }
  }
  #endregion
  ...
  {
    var index = (int)(_bucketSizeM01D15di * ((uint)global::System.Runtime.CompilerServices.RuntimeHelpers.GetHashCode(type) % 4));
  ...
  public override string ToString()
  {
    return
      "classDiagram\n" +
        "  class Composition {\n" +
          "    -IDependency RootM01D15di0001\n" +
          "    -IService RootM01D15di0002\n" +
          "    + T ResolveᐸTᐳ()\n" +
          "    + T ResolveᐸTᐳ(object? tag)\n" +
          "    + object Resolve(Type type)\n" +
          "    + object Resolve(Type type, object? tag)\n" +
        ...
        "  TaskFactory *--  TaskContinuationOptions : TaskContinuationOptions\n" +
        "  TaskFactory *--  TaskScheduler : TaskScheduler\n" +
        "  Composition ..> Dependency : IDependency RootM01D15di0001\n" +
        "  Composition ..> Service : IService RootM01D15di0002";
  }
  ...
  static Composition()
  {
    ...
    OnNewRoot<Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IDependency, Pure.DI.UsageTests.BCL.ServiceCollectionScenario.Dependency>(valResolverM01D15di_0000, "RootM01D15di0001", null, Pure.DI.Lifetime.Singleton);
    ResolverM01D15di<Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IDependency>.Value = valResolverM01D15di_0000;
    var valResolverM01D15di_0001 = new ResolverM01D15di_0001();
    OnNewRoot<Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IService, Pure.DI.UsageTests.BCL.ServiceCollectionScenario.Service>(valResolverM01D15di_0001, "RootM01D15di0002", null, Pure.DI.Lifetime.Transient);
    ResolverM01D15di<Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IService>.Value = valResolverM01D15di_0001;
    _bucketsM01D15di = global::Pure.DI.Buckets<global::System.Type, global::Pure.DI.IResolver<Composition, object>>.Create(
      ...
      {
         new global::Pure.DI.Pair<global::System.Type, global::Pure.DI.IResolver<Composition, object>>(typeof(Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IDependency), valResolverM01D15di_0000)
        ,new global::Pure.DI.Pair<global::System.Type, global::Pure.DI.IResolver<Composition, object>>(typeof(Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IService), valResolverM01D15di_0001)
      });
  }
  ...
  private sealed class ResolverM01D15di_0000: global::Pure.DI.IResolver<Composition, Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IDependency>
  {
    public Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IDependency Resolve(Composition composition)
    {
      return composition.RootM01D15di0001;
    }
  ...
  private sealed class ResolverM01D15di_0001: global::Pure.DI.IResolver<Composition, Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IService>
  {
    public Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IService Resolve(Composition composition)
    {
      return composition.RootM01D15di0002;
    }
