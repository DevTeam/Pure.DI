...
classDiagram
  ...
  Composition ..> Dependency : IDependency RootM01D16di0001
  Composition ..> Service : IService RootM01D16di0002
```
...
partial class Composition
{
  ...
  private Pure.DI.UsageTests.BCL.ServiceCollectionScenario.Dependency _singletonM01D16di33_Dependency;
  ...
  public Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IDependency RootM01D16di0001
  {
    ...
    get
    {
      if (object.ReferenceEquals(_singletonM01D16di33_Dependency, null))
      {
          lock (_disposableSingletonsM01D16di)
          {
              if (object.ReferenceEquals(_singletonM01D16di33_Dependency, null))
              {
                  _singletonM01D16di33_Dependency = new Pure.DI.UsageTests.BCL.ServiceCollectionScenario.Dependency();
              }
          }
      }
  ...
  public Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IService RootM01D16di0002
  {
    #if NETSTANDARD2_0_OR_GREATER || NETCOREAPP || NET40_OR_GREATER || NET
    [global::System.Diagnostics.Contracts.Pure]
    #endif
    get
    {
      ...
      return new Pure.DI.UsageTests.BCL.ServiceCollectionScenario.Service(_singletonM01D16di33_Dependency);
    }
  }
  #endregion
  ...
  static Composition()
  {
    ...
    OnNewRoot<Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IDependency, Pure.DI.UsageTests.BCL.ServiceCollectionScenario.Dependency>(valResolverM01D16di_0000, "RootM01D16di0001", null, Pure.DI.Lifetime.Singleton);
    ResolverM01D16di<Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IDependency>.Value = valResolverM01D16di_0000;
    var valResolverM01D16di_0001 = new ResolverM01D16di_0001();
    OnNewRoot<Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IService, Pure.DI.UsageTests.BCL.ServiceCollectionScenario.Service>(valResolverM01D16di_0001, "RootM01D16di0002", null, Pure.DI.Lifetime.Transient);
    ResolverM01D16di<Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IService>.Value = valResolverM01D16di_0001;
    _bucketsM01D16di = global::Pure.DI.Buckets<global::System.Type, global::Pure.DI.IResolver<Composition, object>>.Create(
      ...
      {
         new global::Pure.DI.Pair<global::System.Type, global::Pure.DI.IResolver<Composition, object>>(typeof(Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IDependency), valResolverM01D16di_0000)
        ,new global::Pure.DI.Pair<global::System.Type, global::Pure.DI.IResolver<Composition, object>>(typeof(Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IService), valResolverM01D16di_0001)
      });
  }
  ...
  private sealed class ResolverM01D16di_0000: global::Pure.DI.IResolver<Composition, Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IDependency>
  {
  ...
  private sealed class ResolverM01D16di_0001: global::Pure.DI.IResolver<Composition, Pure.DI.UsageTests.BCL.ServiceCollectionScenario.IService>
  {
