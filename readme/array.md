...
/// <item>
/// <term>
/// <see cref="Pure.DI.UsageTests.BCL.ArrayScenario.IService"/> <see cref="Root"/><br/>or using <see cref="Resolve{T}()"/> method: <c>Resolve&lt;Pure.DI.UsageTests.BCL.ArrayScenario.IService&gt;()</c>
/// </term>
/// <description>
/// Provides a composition root of type <see cref="Pure.DI.UsageTests.BCL.ArrayScenario.Service"/>.
/// </description>
/// </item>
/// </list>
/// </para>
...
/// </code>
/// </example>
/// <a href="https://mermaid.live/view#pako:eNqdVEtugzAQvYrldaVGsEibHYFUyjZl0YU3Bkap24CRcZHSKHfIXbLpdXKTGjsI83E_2Yzs-bx5vBl8wCnPAC9wuqNVFTG6FTQnghT6jkKel7xikvECkY_ZbL5sYs3JW66fQdQsBbThXHZuFKMNVHxXw-X0FV9OZ-1-0Pbx1zSevEEqm7P_hCTdjspMQltriuJ9CUgqc0N2iH5uOY86NQIh6F7RXUdQQpFBkarbuYkHSdr5tFJe1Nl5qNFXaD1I8gNkoY8wbLV70SlJDdGX_eeNRDyLyhjFptKLuqm06-EmYWf0pLADduer3_ScngbK2huDyj3KoQBdF9_QC2lSSUGvi7G62imkabJ_h3F8h-Ye2OKhiRVRsll1_4Qbj1nvwRCxN8ghI3c3heX-YYYPi6elMVatxmAz-k-N1jUR5N4kl4LXLINuEg0-vsM5iJyyTL1tB4LlK-RA8ILgjIp3go_4-A1tc7y0">Class diagram</a><br/>
...
partial class Composition
{
  ...
  /// </summary>
  /// <example>
  /// This shows how to get an instance of type <see cref="Pure.DI.UsageTests.BCL.ArrayScenario.Service"/>:
  /// <code>
  /// var composition = new Composition();
  /// var instance = composition.Root;
  /// </code>
  ...
  static Composition()
  {
    ...
    ResolverM03D13di<Pure.DI.UsageTests.BCL.ArrayScenario.IService>.Value = valResolverM03D13di_0000;
    _bucketsM03D13di = global::Pure.DI.Buckets<global::System.Type, global::Pure.DI.IResolver<Composition, object>>.Create(
      ...
      {
         new global::Pure.DI.Pair<global::System.Type, global::Pure.DI.IResolver<Composition, object>>(typeof(Pure.DI.UsageTests.BCL.ArrayScenario.IService), valResolverM03D13di_0000)
      });
  }
  ...
  private sealed class ResolverM03D13di_0000: global::Pure.DI.IResolver<Composition, Pure.DI.UsageTests.BCL.ArrayScenario.IService>
  {
