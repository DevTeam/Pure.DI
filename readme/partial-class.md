...
partial class Composition
{
  ...
  public Pure.DI.UsageTests.Basics.PartialClassScenario.IService Root
  {
    ...
    get
    {
      var transientM08D05di1 = new Pure.DI.UsageTests.Basics.PartialClassScenario.Dependency();
      var transientM08D05di0 = new Pure.DI.UsageTests.Basics.PartialClassScenario.Service(transientM08D05di1);
