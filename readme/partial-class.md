...
partial class Composition
{
  ...
  public Pure.DI.UsageTests.Basics.PartialClassScenario.IService Root
  {
    ...
    get
    {
      var transientM09D23di83 = new Pure.DI.UsageTests.Basics.PartialClassScenario.Dependency();
      var transientM09D23di82 = new Pure.DI.UsageTests.Basics.PartialClassScenario.Service(transientM09D23di83);
      return transientM09D23di82;
    }
  }
  #endregion
