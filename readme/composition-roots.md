...
classDiagram
  ...
  Composition ..> Dependency : IDependency RootM12D28di0003
```
...
partial class Composition
{
  ...
  public Pure.DI.UsageTests.Basics.CompositionRootsScenario.IDependency RootM12D29di0003
  {
    #if NETSTANDARD2_0_OR_GREATER || NETCOREAPP || NET40_OR_GREATER || NET
    [global::System.Diagnostics.Contracts.Pure]
    #endif
  ...
  public override string ToString()
  {
    return
      "classDiagram\n" +
        ...
        "  Composition ..> Service : IService Root\n" +
        "  Composition ..> OtherService : \"Other\" IService OtherService\n" +
        "  Composition ..> Dependency : IDependency RootM12D29di0003";
  }
  ...
  static Composition()
  {
    ...
    ResolverM12D29di<Pure.DI.UsageTests.Basics.CompositionRootsScenario.IService>.Value = valResolverM12D29di_0000;
    var valResolverM12D29di_0001 = new ResolverM12D29di_0001();
    ResolverM12D29di<Pure.DI.UsageTests.Basics.CompositionRootsScenario.IDependency>.Value = valResolverM12D29di_0001;
    _bucketsM12D29di = global::Pure.DI.Buckets<global::System.Type, global::Pure.DI.IResolver<Composition, object>>.Create(
      ...
      {
         new global::Pure.DI.Pair<global::System.Type, global::Pure.DI.IResolver<Composition, object>>(typeof(Pure.DI.UsageTests.Basics.CompositionRootsScenario.IService), valResolverM12D29di_0000)
        ,new global::Pure.DI.Pair<global::System.Type, global::Pure.DI.IResolver<Composition, object>>(typeof(Pure.DI.UsageTests.Basics.CompositionRootsScenario.IDependency), valResolverM12D29di_0001)
      });
  }
  ...
  private sealed class ResolverM12D29di_0000: global::Pure.DI.IResolver<Composition, Pure.DI.UsageTests.Basics.CompositionRootsScenario.IService>
  {
  ...
  private sealed class ResolverM12D29di_0001: global::Pure.DI.IResolver<Composition, Pure.DI.UsageTests.Basics.CompositionRootsScenario.IDependency>
  {
    public Pure.DI.UsageTests.Basics.CompositionRootsScenario.IDependency Resolve(Composition composition)
    {
      return composition.RootM12D29di0003;
    }
    
    public Pure.DI.UsageTests.Basics.CompositionRootsScenario.IDependency ResolveByTag(Composition composition, object tag)
    {
      if (Equals(tag, null)) return composition.RootM12D29di0003;;
