...
classDiagram
  ...
  Composition ..> OtherService : IService SomeOtherService<br/>provides "Other" IService
  Composition ..> Service : IService MyRoot<br/>provides IService
  Composition ..> Dependency : IDependency RootM03D14di0003<br/>provides IDependency
```
...
/// <item>
/// <term>
/// <see cref="Pure.DI.UsageTests.Basics.CompositionRootsScenario.IService"/> <see cref="MyRoot"/><br/>or using <see cref="Resolve{T}()"/> method: <c>Resolve&lt;Pure.DI.UsageTests.Basics.CompositionRootsScenario.IService&gt;()</c>
/// </term>
/// <description>
...
/// <item>
/// <term>
/// <see cref="Pure.DI.UsageTests.Basics.CompositionRootsScenario.IService"/> <see cref="SomeOtherService"/><br/>or using <see cref="Resolve{T}(object)"/> method: <c>Resolve&lt;Pure.DI.UsageTests.Basics.CompositionRootsScenario.IService&gt;("Other")</c>
/// </term>
/// <description>
/// Specifies to create a regular public composition root<br/>
...
/// </code>
/// </example>
/// <a href="https://mermaid.live/view#pako:eNqdVEFuwjAQ_Irlc6WmpBItN0ioxAFVAo6-mGQFbkkcOS4SQvyBv_TS7_CTxnZCHBJT6GXleHd2xrOO9zjiMeABjjY0z0NGV4ImRJBUf6OAJxnPmWQ8ReTL8_ojlVOr3mgyB7FlEaDpbsa57EjMeQLvcg2i3DiXhJMQMkhjSKMdUuCp54dPzzHzPM-vG6EFmkHON1s4HX8Wp-O33n7R8fXPMr78gEiqtf-GJF21YKagwhrQYpcBkkX4R3WArlP2Q7WqzDFG1LEfaNwYne3T30NUT8NO2JOo7NWabGvj87JLiT2aO-RgjSPYEtbqZKtr3ICOARoxlmq3lIuihjkXOVtBnXLzmyaNw9YtfKMgoMtcClpOeFzGrjZOMbd3agxmaHuCUNsHi1GBL__bnqYwsTCyNS_VwfnXasFLQR4NOhN8y2LIrZtQYW-gdrGWj4iL6w6Gq-a0XxsnY9NR_IATEAllcfFY7gkuTp4AwQOCYyo-CT7gwy_lXMj9">Class diagram</a><br/>
...
partial class Composition
{
  ...
  /// </summary>
  /// <example>
  /// This shows how to get an instance of type <see cref="Pure.DI.UsageTests.Basics.CompositionRootsScenario.Service"/>:
  /// <code>
  /// var composition = new Composition();
  /// var instance = composition.MyRoot;
  /// </code>
  ...
  /// </summary>
  /// <example>
  /// This shows how to get an instance of type <see cref="Pure.DI.UsageTests.Basics.CompositionRootsScenario.OtherService"/>:
  /// <code>
  /// var composition = new Composition();
  /// var instance = composition.SomeOtherService;
  /// </code>
  /// </example>
  ...
  /// that is only accessible from "Resolve()" methods
  /// </summary>
  public Pure.DI.UsageTests.Basics.CompositionRootsScenario.IDependency RootM03D14di0003
  {
    #if NETSTANDARD2_0_OR_GREATER || NETCOREAPP || NET40_OR_GREATER || NET
    [global::System.Diagnostics.Contracts.Pure]
    #endif
  ...
  static Composition()
  {
    ...
    ResolverM03D14di<Pure.DI.UsageTests.Basics.CompositionRootsScenario.IService>.Value = valResolverM03D14di_0000;
    var valResolverM03D14di_0001 = new ResolverM03D14di_0001();
    ResolverM03D14di<Pure.DI.UsageTests.Basics.CompositionRootsScenario.IDependency>.Value = valResolverM03D14di_0001;
    _bucketsM03D14di = global::Pure.DI.Buckets<global::System.Type, global::Pure.DI.IResolver<Composition, object>>.Create(
      ...
      {
         new global::Pure.DI.Pair<global::System.Type, global::Pure.DI.IResolver<Composition, object>>(typeof(Pure.DI.UsageTests.Basics.CompositionRootsScenario.IService), valResolverM03D14di_0000)
        ,new global::Pure.DI.Pair<global::System.Type, global::Pure.DI.IResolver<Composition, object>>(typeof(Pure.DI.UsageTests.Basics.CompositionRootsScenario.IDependency), valResolverM03D14di_0001)
      });
  }
  ...
  private sealed class ResolverM03D14di_0000: global::Pure.DI.IResolver<Composition, Pure.DI.UsageTests.Basics.CompositionRootsScenario.IService>
  {
  ...
  private sealed class ResolverM03D14di_0001: global::Pure.DI.IResolver<Composition, Pure.DI.UsageTests.Basics.CompositionRootsScenario.IDependency>
  {
    public Pure.DI.UsageTests.Basics.CompositionRootsScenario.IDependency Resolve(Composition composition)
    {
      return composition.RootM03D14di0003;
    }
