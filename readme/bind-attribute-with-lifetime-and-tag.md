...
partial class Composition
{
  ...
  private IGpu? _singletonIGpu2147483131;
  ...
  public IRenderer Renderer
  {
    ...
    get
    {
      if (_singletonIGpu2147483131 is null)
        lock (_lock)
          if (_singletonIGpu2147483131 is null)
          {
            ...
            _singletonIGpu2147483131 = localInstance_1182D1279.HighPerfGpu;
          }

      return new RayTracer(_singletonIGpu2147483131);
    }
  }
}
```
