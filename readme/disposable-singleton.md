...
partial class Composition: global::System.IDisposable
{
  ...
  private Pure.DI.UsageTests.Lifetimes.DisposableSingletonScenario.Dependency _singletonM02D29di34_Dependency;
    ...
    get
    {
      if (ReferenceEquals(_rootM02D29di._singletonM02D29di34_Dependency, null))
      {
          lock (_lockM02D29di)
          {
              if (ReferenceEquals(_rootM02D29di._singletonM02D29di34_Dependency, null))
              {
                  _singletonM02D29di34_Dependency = new Pure.DI.UsageTests.Lifetimes.DisposableSingletonScenario.Dependency();
                  _rootM02D29di._singletonM02D29di34_Dependency = _singletonM02D29di34_Dependency;
                  _rootM02D29di._disposablesM02D29di[_rootM02D29di._disposeIndexM02D29di++] = _singletonM02D29di34_Dependency;
              }
          }
      }
      return new Pure.DI.UsageTests.Lifetimes.DisposableSingletonScenario.Service(_rootM02D29di._singletonM02D29di34_Dependency);
    }
  }
  #endregion
  ...
  static Composition()
  {
    ...
    ResolverM02D29di<Pure.DI.UsageTests.Lifetimes.DisposableSingletonScenario.IService>.Value = valResolverM02D29di_0000;
    _bucketsM02D29di = global::Pure.DI.Buckets<global::System.Type, global::Pure.DI.IResolver<Composition, object>>.Create(
      ...
      {
         new global::Pure.DI.Pair<global::System.Type, global::Pure.DI.IResolver<Composition, object>>(typeof(Pure.DI.UsageTests.Lifetimes.DisposableSingletonScenario.IService), valResolverM02D29di_0000)
      });
  }
  ...
  private sealed class ResolverM02D29di_0000: global::Pure.DI.IResolver<Composition, Pure.DI.UsageTests.Lifetimes.DisposableSingletonScenario.IService>
  {
