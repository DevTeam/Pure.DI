...
partial class Composition: global::System.IDisposable
{
  ...
  private Pure.DI.UsageTests.Lifetimes.DisposableSingletonScenario.Dependency _singletonM01D15di32_Dependency;
    ...
    get
    {
      if (object.ReferenceEquals(_singletonM01D15di32_Dependency, null))
      {
          lock (_disposableSingletonsM01D15di)
          {
              if (object.ReferenceEquals(_singletonM01D15di32_Dependency, null))
              {
                  _singletonM01D15di32_Dependency = new Pure.DI.UsageTests.Lifetimes.DisposableSingletonScenario.Dependency();
                  _disposableSingletonsM01D15di[_disposeIndexM01D15di++] = _singletonM01D15di32_Dependency;
              }
          }
      }
      return new Pure.DI.UsageTests.Lifetimes.DisposableSingletonScenario.Service(_singletonM01D15di32_Dependency);
    }
  }
  #endregion
