...
partial class Composition: global::System.IDisposable
{
  ...
  private Pure.DI.UsageTests.Lifetimes.DisposableSingletonScenario.Dependency _singletonM03D19di34_Dependency;
    ...
    get
    {
      if (ReferenceEquals(_rootM03D19di._singletonM03D19di34_Dependency, null))
      {
          lock (_lockM03D19di)
          {
              if (ReferenceEquals(_rootM03D19di._singletonM03D19di34_Dependency, null))
              {
                  _singletonM03D19di34_Dependency = new Pure.DI.UsageTests.Lifetimes.DisposableSingletonScenario.Dependency();
                  _rootM03D19di._singletonM03D19di34_Dependency = _singletonM03D19di34_Dependency;
                  _rootM03D19di._disposablesM03D19di[_rootM03D19di._disposeIndexM03D19di++] = _singletonM03D19di34_Dependency;
              }
          }
      }
      return new Pure.DI.UsageTests.Lifetimes.DisposableSingletonScenario.Service(_rootM03D19di._singletonM03D19di34_Dependency);
    }
  }
  ...
  static Composition()
  {
    ...
    ResolverM03D19di<Pure.DI.UsageTests.Lifetimes.DisposableSingletonScenario.IService>.Value = valResolverM03D19di_0000;
    _bucketsM03D19di = global::Pure.DI.Buckets<global::System.Type, global::Pure.DI.IResolver<Composition, object>>.Create(
      ...
      {
         new global::Pure.DI.Pair<global::System.Type, global::Pure.DI.IResolver<Composition, object>>(typeof(Pure.DI.UsageTests.Lifetimes.DisposableSingletonScenario.IService), valResolverM03D19di_0000)
      });
  }
  ...
  private sealed class ResolverM03D19di_0000: global::Pure.DI.IResolver<Composition, Pure.DI.UsageTests.Lifetimes.DisposableSingletonScenario.IService>
  {
