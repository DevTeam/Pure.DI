...
partial class Composition: global::System.IDisposable
{
  ...
  private Pure.DI.UsageTests.Lifetimes.DisposableSingletonScenario.Dependency _singletonM03D22di36_Dependency;
    ...
    get
    {
      if (ReferenceEquals(_rootM03D22di._singletonM03D22di36_Dependency, null))
      {
          lock (_lockM03D22di)
          {
              if (ReferenceEquals(_rootM03D22di._singletonM03D22di36_Dependency, null))
              {
                  _singletonM03D22di36_Dependency = new Pure.DI.UsageTests.Lifetimes.DisposableSingletonScenario.Dependency();
                  _rootM03D22di._singletonM03D22di36_Dependency = _singletonM03D22di36_Dependency;
                  _rootM03D22di._disposablesM03D22di[_rootM03D22di._disposeIndexM03D22di++] = _singletonM03D22di36_Dependency;
              }
          }
      }
      return new Pure.DI.UsageTests.Lifetimes.DisposableSingletonScenario.Service(_rootM03D22di._singletonM03D22di36_Dependency);
    }
  }
  ...
  static Composition()
  {
    ...
    ResolverM03D22di<Pure.DI.UsageTests.Lifetimes.DisposableSingletonScenario.IService>.Value = valResolverM03D22di_0000;
    _bucketsM03D22di = global::Pure.DI.Buckets<global::System.Type, global::Pure.DI.IResolver<Composition, object>>.Create(
      ...
      {
         new global::Pure.DI.Pair<global::System.Type, global::Pure.DI.IResolver<Composition, object>>(typeof(Pure.DI.UsageTests.Lifetimes.DisposableSingletonScenario.IService), valResolverM03D22di_0000)
      });
  }
  ...
  private sealed class ResolverM03D22di_0000: global::Pure.DI.IResolver<Composition, Pure.DI.UsageTests.Lifetimes.DisposableSingletonScenario.IService>
  {
