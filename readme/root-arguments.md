...
partial class Composition
{
  ...
  {
    var transientM08D08di1 = new Pure.DI.UsageTests.Basics.RootArgumentsScenario.Dependency(id, dependencyName);
    var transientM08D08di0 = new Pure.DI.UsageTests.Basics.RootArgumentsScenario.Service(serviceName, transientM08D08di1);
