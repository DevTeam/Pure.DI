...
partial class Composition
{
  ...
  {
    var transientM10D25di1 = new Pure.DI.UsageTests.Basics.RootArgumentsScenario.Dependency(id, dependencyName);
    var transientM10D25di0 = new Pure.DI.UsageTests.Basics.RootArgumentsScenario.Service(serviceName, transientM10D25di1);
