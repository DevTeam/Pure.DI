...
partial class Composition
{
  ...
  public IService Root
  {
    ...
    get
    {
      ...
      Func<int, string, IDependency> localFactory105 = new Func<int, string, IDependency>((int localArg121, string localArg229) =>
      {
        lock (localLockObject104)
        {
          overInt320 = localArg121;
          overString2 = localArg229;
