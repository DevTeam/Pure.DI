...
partial class Composition
{
  ...
  public IService Root
  {
    ...
    get
    {
      ...
      lock (_lock)
      {
        Func<int, string, IDependency> localFactory110 = new Func<int, string, IDependency>((int localArg112, string localArg220) =>
        {
          Lock transLock2 = _lock;
          Lock localLockObject111 = transLock2;
          lock (localLockObject111)
          {
            int overrInt320 = localArg112;
            string overrString2 = localArg220;
